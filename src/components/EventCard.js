...
export default function EventCard({ title, text,imgSrc }) {
    return(
        <Card style={{ minWidth:'200px', maxWidth: '240px', height:'300px', border:'0'}} className='mx-auto my-5 rounded-3 col-md-1 mx-md-auto mx-md-5 col-sm-1 mx-sm-5 mx-sm-auto hover-effect'>
